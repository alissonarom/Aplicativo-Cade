...
import { Button, Dialog, Portal, useTheme, Drawer, Menu } from 'react-native-paper';
      ...
      <Portal>
        <Dialog visible={visible} onDismiss={hideDialog}>
          <Dialog.Actions style={{flexDirection: "column", padding: 0, width: "90%"}}>
            <Menu.Item onPress={() => navigation.navigate('#'), hideDialog} title="Editar Perfil" style={{ width: "100%", margin: 0 }} />
